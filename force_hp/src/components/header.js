...
export default class Header extends React.Component {
  ...
  render() {
    return (
        ...
        //             <Nav.Link className={"js-scroll-trigger"} href="#about"><Link to="/company_information/CompanyProfile">企業情報</Link></Nav.Link>
        //           </li>
        //           <li className="nav-item">
        //             <Nav.Link className={"js-scroll-trigger"} href="#services"><Link to="/recruitment/recruit">採用情報</Link></Nav.Link>
        //           </li>
        //           <li className="nav-item">
        //             <Nav.Link className={"js-scroll-trigger"} href="#portfolio"><Link to="/access/access">アクセス</Link></Nav.Link>
        //           </li>
        //           <li className="nav-item">
        //             <Nav.Link className={"js-scroll-trigger"} href="#contact"><Link to="/company_information/CompanyProfile">お問い合わせ</Link></Nav.Link>
        //           </li>
        //         </Scrollspy>
        //       </Nav>
        //     </Navbar.Collapse>
